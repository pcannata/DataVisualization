...
Use a GUI tool like SourceTree or execute the following commands in a terminal window:

**Phils-MacBook-Pro:Mine pcannata$ pwd**  
/Users/pcannata  
**Phils-MacBook-Pro:Mine pcannata$ git clone https://github.com/pcannata/DataVisualization.git**  
